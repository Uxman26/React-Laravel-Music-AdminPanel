...
import {ManageAccountsIcon} from '@common/icons/material/ManageAccounts';
import {ReactElement} from 'react';
import {ListboxItemProps} from '@common/ui/forms/listbox/item';
import {useNavigate} from 'react-router-dom';

export interface NavbarAuthUserMobileAdminProps {
  items?: ReactElement<ListboxItemProps>[];
}

export function NavbarAuthUserMobileAdmin({
  items = [],
