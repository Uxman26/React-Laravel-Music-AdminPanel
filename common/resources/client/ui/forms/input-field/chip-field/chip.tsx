...
export function Chip(props: ChipProps) {
  ...
  return (
    ...
    >
      {adornment}
      <div className="flex-auto overflow-hidden overflow-ellipsis text-white font-black">
        {children}
      </div>
      {onRemove && (
        <ButtonBase
  ...
  switch (size) {
    ...
    default:
      return {
        ...
        chip: clsx('pl-6 h-28 text-sm', !onRemove && 'pr-6'),
...
function colorClassName({color}: ChipProps): string {
  switch (color) {
    ...
    default:
      return `bg-chip border-color-chip text-small`;
  }
}
