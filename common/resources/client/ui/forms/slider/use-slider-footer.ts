...
export interface UseSliderFooterProps<T = number[]> {
...
export interface UseSliderFooterReturn {
...
export function useSliderFooter({
  minValue = 0,
  maxValue = 100,
  isDisabled = false,
  step = 1,
  ...
  onPointerMove,
  ...props
}: UseSliderFooterProps): UseSliderFooterReturn {
