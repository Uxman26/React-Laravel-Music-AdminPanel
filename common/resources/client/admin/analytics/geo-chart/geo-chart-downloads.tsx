...
import {useGoogleGeoChartDownloads} from './use-google-geo-chart-downloads';
...
interface GeoChartDownloadsData extends Partial<ChartLayoutProps> {
  data?: ReportMetric<LocationDatasetItem>;
  onCountrySelected?: (countryCode: string | undefined) => void;
  country?: string;
}
export function GeoChartDownloads({
  data: metricData,
  isLoading,
  onCountrySelected,
  country,
  ...layoutProps
}: GeoChartDownloadsData) {
  ...
  useGoogleGeoChartDownloads({placeholderRef, data, country, onCountrySelected});
