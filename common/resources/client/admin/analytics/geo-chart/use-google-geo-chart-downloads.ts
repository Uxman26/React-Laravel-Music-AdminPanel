...
interface UseGoogleGeoChartDownloadsProps {
  placeholderRef: RefObject<HTMLDivElement>;
  data: LocationDatasetItem[];
  onCountrySelected?: (countryCode: string) => void;
  country?: string;
}
export function useGoogleGeoChartDownloads({
  placeholderRef,
  data,
  country,
  onCountrySelected,
}: UseGoogleGeoChartDownloadsProps) {
  ...
  const initGoogleGeoChartDownloads = useCallback(async () => {
