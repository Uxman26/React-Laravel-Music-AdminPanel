...
use App\Http\Controllers\DownloadsReportController;
...
use App\Http\Controllers\TrackDownloadsController;
...
Route::group(['prefix' => 'v1', 'middleware' => ['optionalAuth:sanctum', 'verified']], function() {
    ...
    // TRACK DOWNLOADS
    // Route::get('tracks/downloads/report', [DownloadsReportController::class, 'index']);
    Route::get('tracks/downloads/{userId}', [TrackDownloadsController::class, 'index']);
    Route::post('tracks/downloads/{track}/log', [TrackDownloadsController::class, 'create']);
    ...
    // REPORTS
    Route::get('reports/downloads', DownloadsReportController::class);
