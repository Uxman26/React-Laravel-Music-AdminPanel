...
class TrackFactory extends Factory
{
    ...
    public function definition(): array
    {
        ...
        return [
            ...
            'mp3_file' => "storage/samples/{$sampleNumber}.mp3",
            'wav_file' => "storage/samples/{$sampleNumber}.wav", 
            'zip_file' => "storage/samples/{$sampleNumber}.zip",
            'pdf_file' => "storage/samples/{$sampleNumber}.pdf",         
