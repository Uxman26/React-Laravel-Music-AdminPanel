...
class CustomPagesSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        'body' => '<p>Welcome to KrabickaPohádek ("us", "we", or "our"). At http://localhost, we value your privacy and strive to protect your personal information. This Privacy Policy outlines the types of data we collect, how we use and protect it, and your rights regarding your personal information.</p>
...
',
            ...
            1 => array(
                ...
                'body' => '<p>
  Welcome to KrabickaPohádek ("us", "we", or "our"). By accessing and using our website, you agree to
