    ...
    public function run()
    {
        ...
        DB::table('settings')->insert([
            ...
            57 => array(
                ...
                'value' => '{"headerTitle":"Connect on KrabickaPohádek","headerSubtitle":"Discover, stream, and share a constantly expanding mix of music from emerging and major artists around the world.","headerImage":"images\\/landing\\/landing-header-bg.jpg","headerOverlayColor1":"rgba(16,119,34,0.56)","headerOverlayColor2":"rgba(42,148,71,1)","headerImageOpacity":"0.2","footerTitle":"Make music? Create audio?","footerSubtitle":"Get on KrabickaPohádek to help you connect with fans and grow your audience.","footerImage":"images\\/landing\\/landing-footer-bg.jpg","actions":{"inputText":"Search for artists, albums and tracks...","inputButton":"Search","cta1":{"label":"Signup Now","type":"route","action":"\\/register"},"cta2":{"label":"Explore","type":"route","action":"\\/discover"},"cta3":{"label":"Sign up for free","type":"route","action":"\\/register"}},"primaryFeatures":[],"secondaryFeatures":[{"title":"Stream Anytime, Anywhere. From Any Device.","subtitle":"Complete Freedom","image":"images\\/landing\\/landing-feature-1.jpg","description":"Stream music in the browser, on Phone, Tablet, Smart TVs, Consoles, Chromecast, Apple TV and more."},{"title":"Get More From KrabickaPohádek With Pro","subtitle":"KrabickaPohádek Pro","image":"images\\/landing\\/landing-feature-2.jpg","description":"Subscribe to KrabickaPohádek pro to hide ads, increase upload time and get access to other exclusive features."}],"pricingTitle":"Simple pricing, for everyone.","pricingSubtitle":"Choose the plan that works for you. No commitments, cancel anytime.","channelIds":[1]}',
                'created_at' => '2024-04-11 19:25:04',
                'updated_at' => '2024-04-11 19:25:04',
                'private' => 0,
            ),
