            ...
            {imageUrl ? (
              <>
                <span className="text-sm">
                  <Trans message={`Replace PDF`} />
                </span>
                <br />
                <span className="" style={{ fontSize: '0.6rem' }}>
                    <Trans message={`.PDF file`} />
                </span>
              </>
            ) : (
              <>
                <span className="text-sm">
                  <Trans message={`Upload PDF`} />
                </span>
                <br />
                <span className="" style={{ fontSize: '0.6rem' }}>
                  <Trans message={`.PDF file`} />
...
interface PDFFileUploadButtonProps extends ImageSelectorProps {
  name: string;
}
export function PDFFileUploadButton(props: PDFFileUploadButtonProps) {
  const {
