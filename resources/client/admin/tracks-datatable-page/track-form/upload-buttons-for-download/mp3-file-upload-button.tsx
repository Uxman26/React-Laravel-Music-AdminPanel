            ...
            {imageUrl ? (
              <>
                <span className="text-sm">
                  <Trans message={`Replace MP3`} />
                </span>
                <br />
                <span className="" style={{ fontSize: '0.6rem' }}>
                    <Trans message={`.MP3 file`} />
                </span>
              </>
            ) : (
              <>
                <span className="text-sm">
                  <Trans message={`Upload MP3`} />
                </span>
                <br />
                <span className="" style={{ fontSize: '0.6rem' }}>
                  <Trans message={`.MP3 file`} />
...
interface MP3FileUploadButtonProps extends ImageSelectorProps {
  name: string;
}
export function MP3FileUploadButton(props: MP3FileUploadButtonProps) {
  const {
