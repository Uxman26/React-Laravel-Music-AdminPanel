            ...
            {imageUrl ? (
              <>
                <span className="text-sm">
                  <Trans message={`Replace ZIP`} />
                </span>
                <br />
                <span className="" style={{ fontSize: '0.6rem' }}>
                    <Trans message={`.ZIP file`} />
                </span>
              </>
            ) : (
              <>
                <span className="text-sm">
                  <Trans message={`Upload ZIP`} />
                </span>
                <br />
                <span className="" style={{ fontSize: '0.6rem' }}>
                  <Trans message={`.ZIP file`} />
...
interface ZIPFileUploadButtonProps extends ImageSelectorProps {
  name: string;
}
export function ZIPFileUploadButton(props: ZIPFileUploadButtonProps) {
  const {
