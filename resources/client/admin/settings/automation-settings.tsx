  ...
  return (
    <Fragment>
        ...
        {isInvalid => (
          <Fragment>
            ...
            <FormTextField
              ...
              required
              description={
                <Trans message="Your Spotify secret key, necessary for authentication with the Spotify API." />
              }
            />
          </Fragment>
        )}
      ...
      <FormTextField
        ...
        description={
          <Trans message="Your LastFM API key, needed for integrating with the LastFM service." />
        }
      />
    </Fragment>
  );
