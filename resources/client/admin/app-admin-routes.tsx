...
import {KrabickapohadekAdminReportPage} from '@app/admin/reports/krabickapohadek-admin-report-page';
import {AdminInsightsReport} from '@app/admin/reports/admin-insights-report';
import {AdminDownloadsReport} from '@app/admin/reports/admin-downloads-report';
...
export const AppAdminRoutes: RouteObject[] = [
  ...
  {
    path: '/',
    element: <KrabickapohadekAdminReportPage />,
    children: [
      {index: true, element: <AdminInsightsReport />},
      {path: 'plays', element: <AdminInsightsReport />},
      {path: 'downloads', element: <AdminDownloadsReport />},
