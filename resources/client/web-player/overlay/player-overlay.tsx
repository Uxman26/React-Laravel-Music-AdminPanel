...
import {TrackLike} from '@app/web-player/tracks/track-table/column-options/track-like';
  ...
  return (
    <div
      ...
      className={clsx(
        ...
        isMaximized
          ? 'player-overlay-bg bottom-0 flex h-full w-full flex-col pb-50 gap-x-16'
          : 'bottom-96 right-0 h-[213px] w-256',
      )}
    >
      {isMaximized && (
        <div className="mb-20 flex flex-shrink-0 items-center p-10 gap-x-16">
          <IconButton
            iconSize="lg"
            className="mr-auto"
          ...
          <LyricsButton />
          {cuedTrack && <TrackDemoDownload track={cuedTrack} />}
          <IconButton
...
function QueuedTrack() {
  ...
  return (
    <div className="container mx-auto my-40 flex flex-shrink-0 items-center justify-center gap-x-34 px-14 md:my-60">
