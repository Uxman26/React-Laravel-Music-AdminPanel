...
import {FollowPlaylistButtonDarkMode} from '@app/web-player/playlists/playlist-page/follow-playlist-button-dark-mode';
...
export function PlaylistGridItem({playlist}: PlaylistGridItemProps) {
  return (
    <PlayableGridItem
      ...
      likeButton={
        <FollowPlaylistButtonDarkMode buttonType="icon" size="md" playlist={playlist} />
      }
      model={playlist}
