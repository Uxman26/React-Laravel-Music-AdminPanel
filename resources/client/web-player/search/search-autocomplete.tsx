    ...
    <>
      {isDarkMode ? (
        <form
          ...
          className={clsx(
            'flex max-w-500 flex-auto items-center gap-14 rounded bg-grey-100',
            className,
          )}
        >
          <button
          ...
          <ComboBox
            unstyled
            className="w-full max-w-500 flex-auto rounded"
            offset={12}
        ...
        <form
          ...
          className={clsx(
            'bg-lighter flex max-w-500 flex-auto items-center gap-14 rounded',
            className,
          )}
        >
          <button
